...
export function GameCard({ game, onPlay }: GameCardProps) {
  ...
  return (
    <Card className="overflow-hidden hover-elevate active-elevate-2 transition-all duration-300 group cursor-pointer border border-card-border hover:border-primary/30">
      <div className="relative h-52 overflow-hidden bg-gradient-to-br from-card to-card/70 border-b border-card-border">
        ...
        <div className="absolute inset-0 flex duration-300 transition-all transform">
          <div className="text-7xl font-display font-light text-primary/15 hove:scale-[102] transition-colors duration-300">
            <img src={game.imageUrl} alt="" className={"w-full h-full object-cover object-contain"} />
          </div>
        </div>
      </div>
